...
class SleepAiErrorFormat(AppHTTPException):
    http_code = status.HTTP_404_NOT_FOUND
    user_message = "Error format JSON from SleepAi"


class SleepAiErrorConnect(AppHTTPException):
    http_code = status.HTTP_502_BAD_GATEWAY
    user_message = "Error connect to SleepAi"